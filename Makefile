# This Makefile is for the cpan-testers-server-build extension to perl.
#
...
#     ABSTRACT => q[How to build the CPAN Testers server]
#     AUTHOR => [q[Barbie <barbie@cpan.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[cpan-testers-server-build]
#     NO_META => q[1]
#     PREREQ_PM => { CPAN::Testers=>q[0.07] }
#     TEST_REQUIRES => {  }
#     VERSION => q[1.00]
...
NAME_SYM = cpan_testers_server_build
VERSION = 1.00
...
INSTALLARCHLIB = /usr/lib/x86_64-linux-gnu/perl/5.20
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = /usr/local/lib/x86_64-linux-gnu/perl/5.20.2
DESTINSTALLSITEARCH = $(DESTDIR)$(INSTALLSITEARCH)
INSTALLVENDORARCH = /usr/lib/x86_64-linux-gnu/perl5/5.20
...
MAKE = make
FULLEXT = cpan-testers-server-build
BASEEXT = build
PARENT_NAME = 
DLBASE = $(BASEEXT)
VERSION_FROM = 
...
DISTNAME = cpan-testers-server-build
DISTVNAME = cpan-testers-server-build-1.00
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>How to build the CPAN Testers server</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Barbie &lt;barbie@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="CPAN::Testers" VERSION="0.07" />' >> $(DISTNAME).ppd
